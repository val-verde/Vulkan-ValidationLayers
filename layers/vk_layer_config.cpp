...
VK_LAYER_EXPORT const SettingsFileInfo &GetSetLayerSettingsFileInfo() { return layer_config.settings_info; }
...
string ConfigFile::FindSettings() {
    ...
    char buff[512];
    auto bufptr = GetCurrentDir(buff, 512);
    settings_info.location = buff;
